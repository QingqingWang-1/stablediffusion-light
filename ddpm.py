#unconditional diffusion model, use LandScape dataset
import os 
...
def train(args):
    ...
    model = UNet(remove_deep_conv=True).to(device)    #use smaller UNet by removing bot2 = DoubleConv(512, 512)
...
def launch():
    ...
    args.batch_size = 12
    args.image_size = 48
    args.dataset_path = r"data/Landscape"
    args.device = "cuda"
    args.lr = 3e-4
    train(args)
